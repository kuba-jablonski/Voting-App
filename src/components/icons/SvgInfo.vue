<template>
  ...
  >
    ...
    <rect
      ...
      fill="#ed4545"
    />
    <rect x="886.13" y="652.15" width="103.43" height="7.86" fill="#ed4545" />
    <rect x="868.55" y="668.74" width="142.32" height="7.86" fill="#ed4545" />
    <rect x="868.55" y="686.2" width="142.32" height="7.86" fill="#ed4545" />
    <rect x="868.55" y="703.66" width="142.32" height="7.86" fill="#ed4545" />
    <rect
      y="482.59"
      width="426.61"
      height="208.22"
    ...
    <rect
      ...
      fill="#ed4545"
    />
    <rect x="87.15" y="583.32" width="243.53" height="7.86" fill="#ed4545" />
    <rect x="45.75" y="599.91" width="335.1" height="7.86" fill="#ed4545" />
    <rect x="45.75" y="617.37" width="335.1" height="7.86" fill="#ed4545" />
    <rect x="45.75" y="634.83" width="335.1" height="7.86" fill="#ed4545" />
    <path
